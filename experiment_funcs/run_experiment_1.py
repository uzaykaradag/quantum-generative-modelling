...
def run_experiment_1(data, qubit_range, depth_range, sgada_hyperparams, sgld_hyperparams, output_folder, stochastic_flag=False):
    ...
    for n_qubits in qubit_range:
        for circuit_depth in depth_range:
            ...
            # Allocate results
            model_SGADA = {'output': None, 'cost_vals':None, 'run_time':None, 'params':None, 'param_to_st':None}
            model_SGLD  = {'output': None, 'cost_vals':None, 'run_time':None, 'params':None, 'param_to_st':None}
